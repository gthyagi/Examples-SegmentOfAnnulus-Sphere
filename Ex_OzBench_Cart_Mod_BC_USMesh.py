# ### OzBench model with freeslip boundaries in unstructured simple box
...
ymin, ymax = 0., 1.0
resx, resy = 192, 48
cellsize = 1/48 # 1/2, 1/4, 1/16, 1/32, 1/48, 1/64, 1/128

# +
# creating output directory
meshes_dir = os.path.join(os.path.join("./"), "meshes/")
output_dir = os.path.join(os.path.join("./output/"), f"OzBench_Cart_Mod_BC_USMesh_Test{test_no}/")
...
if uw.mpi.size == 1:
    ...
    mesh.vtk(output_dir+f"OzBench_Cart_Mod_BC_USMesh_Test{test_no}.vtk")
    pvmesh = pv.read(output_dir+f"OzBench_Cart_Mod_BC_USMesh_Test{test_no}.vtk")
...
# mesh vtk file 
mesh_file = output_dir+f"OzBench_Cart_Mod_BC_USMesh_Test{test_no}.vtk"
